        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-custom-background rounded-lg p-6">
              ...
              <p className="text-custom-text text-justify">
                La thérapie de couple répond au désir de quitter une souffrance. Elle s'adresse aux couples en crise mais aussi à ceux ayant de légers problèmes de communication ou souffrant de disputes à répétition. L'objectif est de permettre aux partenaires de retrouver l'harmonie et d'améliorer leur communication pour renforcer leur lien et leur bien-être.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-custom-background py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-custom-text mb-8 max-w-2xl mx-auto">
            ...
            Je suis là pour vous accompagner dans votre relation.
          </p>
          <a
